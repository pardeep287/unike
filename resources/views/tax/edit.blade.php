...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <h1 class="page-header margintop10"> {!! lang('common.edit_heading', lang('tax.tax')) !!} #{{ $result->name }}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- end: PAGE HEADER -->
    ...
    <div class="row">
        ...
        {!! Form::model($result, array('route' => array('tax.update', $result->id), 'method' => 'PATCH', 'id' => 'tax-form', 'class' => 'form-horizontal')) !!}
