                        ...
                        <div class="panel-body">
                            <div>
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li data-tab = '3' role="presentation" class="hidden @if($tab == 3) active @endif">
                                        ...
                                        <div class="col-md-12 margintop20">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        {!! Form::label('brand_name', lang('setting.brand_name'), array('class' => 'col-sm-4 control-label')) !!}
                                                        <div class="col-sm-8">
                                                            {!! Form::text('brand_name', $company->brand_name, array('class' => 'form-control')) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            {!! Form::text('abn_number', $company->abn_number, array('class' => 'form-control')) !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            {!! Form::select('currency', $currency, isset($setting->currency_id)?$setting->currency_id:null, ['class' => 'form-control select2']) !!}
                                                        </div>
                                                    </div>
