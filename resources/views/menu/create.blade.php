...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <h1 class="page-header margintop10">{!! lang('common.create_menu', lang('menu.menu')) !!}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- end: PAGE HEADER -->
    ...
    <div class="row">
        <div class="col-md-12 padding0">
            {!! Form::open(array('method' => 'POST', 'route' => array('menu.store'), 'id' => 'menu-form', 'class' => 'form-horizontal')) !!}
            <div class="col-md-12">
