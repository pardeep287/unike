...
<div id="page-wrapper">
	<div class="row topheading-row">
		<div class="col-lg-6 col-md-6 col-sm-9 col-xs-12">
			<h1 class="page-header margintop10"> {!! lang('size.size') !!} </h1>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-3 col-xs-12">

			@if(isAdmin())
				<a class="btn btn-sm btn-default pull-right margintop10 marginbottom10" href="{{ route('hsn.create') }}"> <i class="fa fa-plus fa-fw"></i> {!! lang('common.create_heading', lang('hsn.hsn'))  !!} </a>
			@endif
		</div>
