...
<div id="page-wrapper">
	<div class="row topheading-row">
		<div class="col-lg-6 col-md-6 col-sm-9 col-xs-12">
			<h1 class="page-header margintop10">   {!! string_manip(lang('report.report'), 'UCW') !!} - {!! lang('report.account_statement') !!} </h1>
		</div>
	...
	<div class="col-md-12">
		{!! Form::open(array('method' => 'POST', 'route' => array('report.account-statement-paginate'), 'id' => 'ajaxForm')) !!}
		<div class="row">

			<div class="col-sm-2">
				<div class="form-group">
					{!! Form::label('account', lang('account.account'), array('class' => 'control-label')) !!}
					{!! Form::select('account', getAccountIn(), (isset($inputs['account'])) ? $inputs['account'] : '', array('class' => 'form-control padding0', 'required' => true)) !!}
				</div>
			</div>
			...
			<div class="col-sm-2 margintop20">
				<div class="form-group">
					...
					<a href="{!! route('report.account-statement') !!}" class="btn btn-primary" title="{!! lang('common.reset_filter') !!}"> {!! lang('report.reset_filter') !!}</a>
				</div>
			</div>
		</div>
		{!! Form::close() !!}
	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body padding0" id="p-report">
				<table id="paginate-load" data-route="{!! route('report.account-statement-paginate') !!}" class="table table-responsive table-hover table-bordered clearfix margin0 col-md-12 padding0 table-report1">
				</table>
			</div>
		</div>
