<div class="invoice-box" style="clear: both;"><br/>
    <table style="margin-left:0px;margin: 0 auto; width:480px;" cellspacing="0" cellpadding="0">
        ...
        <tr class="top">
            <td colspan="4">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td colspan="4" class="title" style="text-align: center; font-weight: 600; font-size: 1.2em;">
                            @if($copy == 1)
                ...
                <table valign="" top="" width="100%" cellspacing="0" cellpadding="5" border="0">
                    ...
                    <tr>
                        <td style="font-size: 1.1em;" valign="top" width="100%">
                            {!! $party->salutation  . ' ' . $party->account_name . ' <br/>' . $party->address1 !!} <br/>
                            @if($party->city != "")
                                {!! $party->city !!}
                            @endif
            ...
            <td colspan="2" style="border-width:1px 1px 0px 1px;border-style:solid ;border-color:#555555;" width="50%">
                <table width="100%" cellspacing="2" cellpadding="0" border="0" style="font-size: 1.0em;">
                    ...
                    @if($company->state_name != "")
                        <tr>
                            <td width="40%" bgcolor="#ffffa8" style="padding-top:0;padding-bottom: 0;">Place of Supply :</td>
        ...
        <tr>
            <td colspan="4" style="border: 1px solid #000;border-top: 0;">
                    ...
                    <tr>
                        ...
                        <td style="width: 33.3%;text-align:center;">
                            <div style="font-size: 13px;padding-top: 5px;">
                                <strong> A/C Number:</strong> {!! $bank->account_number !!} <br>
                            </div>
                        </td>
                        <td style="width: 33.3%;text-align:center;"><strong>IFS CODE:</strong><br> {!! $bank->ifsc_code !!}</td>
                    </tr>
                    </tbody>
                </table>
            </td>
                        ...
                        <tr valign="top">
                            <td style="border-right:0;border-top:0;border-bottom:0;background: #ccffbf;" width="50%">
                                <table width="100%" cellspacing="0" cellpadding="3" border="0">
                                    ...
                                    <tr>
                                        <td style="font-size: 0.4em;padding-bottom: 0;">
                                            {!! nl2br($setting->terms) !!}
                                        </td>
                                    </tr>
                                    </tbody>
        ...
        <tr>
            <td colspan="4">
                ...
                <table width="100%">
                    <tr>
                        <td width="50%" style="padding: 5px 0;font-size: 13px;font-weight:bold;"> This is computer generated
                            invoice.
                        </td>
